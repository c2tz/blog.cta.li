...
html,body,main,.gsc-main{background:transparent!important;color:${colors.onSurface};font-family:Roboto,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
...
.gsc-reply-box,.gsc-comment-box{background:transparent}
